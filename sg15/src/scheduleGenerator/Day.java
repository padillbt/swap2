 ...
 *         Created Oct 15, 2012.
 */
//SMELL: Lazy Class - the Day class does very little aside from hold data for other
// classes to manipulate. It is likely that some related functionality could be moved
