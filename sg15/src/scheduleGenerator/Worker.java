...
// modifications.
//SMELL: Data class - the Worker class is mostly get and set methods with minimal useful
// logic. If more functionality could be pushed into it, it would save changes elsewhere.
public class Worker implements Serializable{
	 ...
	 * @param jobs
	 */
	public Worker(String name, ArrayList<Day> days, HashMap<String, Integer> amountToWork)
	{
		this.name = name;
		this.days = days;
